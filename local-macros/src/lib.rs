        ...
        "NodeInterface" => {
            quote! {
                impl crate::NodeInterface for #ast_type_name {
                    ...
                    fn maybe_emit_node(&self) -> ::std::cell::RefMut<::std::option::Option<::std::rc::Rc<crate::EmitNode>>> {
                        self.#first_field_name.maybe_emit_node()
                    }

                    fn set_emit_node(&self, emit_node: ::std::option::Option<::std::rc::Rc<crate::EmitNode>>) {
