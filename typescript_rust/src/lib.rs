...
pub use compiler::{
    ...
    core::{
        add_range, append, append_if_unique_eq, append_if_unique_rc,
        ...
        contains, contains_comparer, contains_rc, count_where,
        create_get_canonical_file_name, create_multi_map, create_multi_map_ordered,
        create_underscore_escaped_multi_map, deduplicate_eq, deduplicate_rc, element_at, ends_with,
        ...
        maybe_add_range, maybe_append_if_unique_eq,
        ...
        try_every, try_filter, try_find, try_find_index, try_find_last, try_first_defined,
        try_flat_map, try_for_each, try_for_each_bool, try_get_spelling_suggestion, try_map,
        try_map_defined, try_maybe_every, try_maybe_filter, try_maybe_first_defined,
        try_maybe_for_each, try_maybe_map, try_reduce_left, try_reduce_left_no_initial_value,
        try_reduce_left_no_initial_value_optional, try_some, try_span_map, AssertionLevel,
    ...
    factory::{
        ...
        emit_node::{
            ...
            move_synthetic_comments, remove_all_comments, set_comment_range,
    ...
    types::{
        ...
        SymbolVisibilityResult, SymbolWalker, SymbolWriter, SyntaxKind, SyntaxList,
        SynthesizedComment, SyntheticExpression, SyntheticReferenceExpression,
        ...
        TransformerFactory, TransformerFactoryInterface,
