...
pub use compiler::{
    binder::{bind_source_file, get_module_instance_state, ActiveLabel, ModuleInstanceState},
    ...
    command_line_parser::{
        ...
        parse_list_type_option, read_config_file, ConfigFileDiagnosticsReporter,
    ...
    core::{
        add_range, add_range_option, append, append_if_unique_eq, append_if_unique_rc,
        array_is_equal_to, array_of, array_to_map, array_to_multi_map, arrays_equal, binary_search,
        binary_search_copy_key, cartesian_product, cast, cast_present, clear, clone,
        compare_booleans, compare_strings_case_insensitive, compare_strings_case_sensitive,
        compare_strings_case_sensitive_maybe, compare_values, comparison_to_ordering, concatenate,
        contains, contains_comparer, contains_rc, count_where, create_get_canonical_file_name,
        create_multi_map, create_multi_map_ordered, create_underscore_escaped_multi_map,
        deduplicate_eq, deduplicate_rc, element_at, ends_with, equate_strings_case_insensitive,
        equate_strings_case_sensitive, equate_values, every, fill, filter, filter_iter,
        filter_mutate, filter_owning, find, find_best_pattern_match, find_index, find_last,
        find_last_index, find_last_index_returns_isize, first, first_defined, first_or_undefined,
        flat_map, flat_map_to_mutable, flatten, for_each, for_each_bool, get_or_update,
        get_or_update_indexmap, get_ranges_where, get_spelling_suggestion, get_string_comparer,
        get_ui_locale, group, identity, identity_str_to_cow, identity_str_to_owned,
        index_of_any_char_code, indices_of, insert_sorted, last, last_or_undefined, length, map,
        map_defined, matched_text, maybe_add_range, maybe_append_if_unique_eq,
        maybe_append_if_unique_rc, maybe_concatenate, maybe_every, maybe_filter,
        ...
        pattern_text, push_if_unique_eq, push_if_unique_rc, range_equals, range_equals_rc,
        reduce_left, reduce_left_no_initial_value, reduce_left_no_initial_value_optional,
        relative_complement, remove_prefix, remove_suffix, replace_element, same_flat_map_id_node,
        same_map, set_ui_locale, single_element_array, single_or_many_node, single_or_undefined,
        some, sort, sort_and_deduplicate, span_map, stable_sort, starts_with, string_contains, sum,
        take_while, to_file_name_lower_case, trim_string, trim_string_end, trim_string_start,
        try_add_to_set, try_cast, try_count_where, try_every, try_filter, try_find, try_find_index,
        try_find_last, try_first_defined, try_flat_map, try_for_each, try_for_each_bool,
        try_get_spelling_suggestion, try_map, try_map_defined, try_maybe_every, try_maybe_filter,
        try_maybe_first_defined, try_maybe_for_each, try_maybe_map, try_reduce_left,
        try_reduce_left_no_initial_value, try_reduce_left_no_initial_value_optional, try_some,
        try_span_map, AssertionLevel, Cloneable, MultiMap, MultiMapOrdered, Pattern, SingleOrVec,
    ...
    debug::{Debug_, LogLevel, LoggingHost},
    ...
    factory::{
        base_node_factory::{create_base_node_factory, BaseNodeFactory, BaseNodeFactoryConcrete},
        emit_helpers::{
            advanced_async_super_helper, async_super_helper, create_emit_helper_factory,
            is_call_to_helper, EmitHelperFactory,
        },
        emit_node::{
            ...
            move_synthetic_comments, remove_all_comments, set_comment_range, set_constant_value,
            set_emit_flags, set_source_map_range, set_synthetic_leading_comments,
            set_synthetic_trailing_comments, set_token_source_map_range,
        },
        node_converters::{create_node_converters, null_node_converters},
        node_factory::{
            create_input_files, create_node_factory, create_unparsed_source_file, get_factory,
            get_factory_id, get_synthetic_factory, has_node_array_changed,
            has_option_node_array_changed, has_option_str_or_node_changed, set_original_node,
            BaseNodeFactorySynthetic, NodeFactoryFlags, NumberOrRcNode, ReadFileCallback,
            StrOrRcNode, StringOrNumber, StringOrNumberOrBoolOrRcNode, StringOrRcNode,
            SyntaxKindOrRcNode,
        },
        node_tests::{
            is_abstract_modifier, is_array_binding_pattern, is_array_literal_expression,
            is_array_type_node, is_arrow_function, is_as_expression, is_assert_clause,
            is_assert_entry, is_asserts_keyword, is_asterisk_token, is_async_modifier,
            is_await_expression, is_await_keyword, is_big_int_literal, is_binary_expression,
            is_binding_element, is_block, is_break_statement, is_bundle, is_call_expression,
            is_call_signature_declaration, is_case_block, is_case_clause, is_catch_clause,
            is_class_declaration, is_class_expression, is_class_static_block_declaration,
            is_colon_token, is_comma_list_expression, is_comma_token, is_computed_property_name,
            is_conditional_expression, is_conditional_type_node,
            is_construct_signature_declaration, is_constructor_declaration,
            is_constructor_type_node, is_continue_statement, is_debugger_statement, is_decorator,
            is_default_clause, is_delete_expression, is_do_statement, is_dot_dot_dot_token,
            is_element_access_expression, is_empty_statement, is_end_of_declaration_marker,
            is_enum_declaration, is_enum_member, is_equals_greater_than_token,
            is_exclamation_token, is_export_assignment, is_export_declaration, is_export_modifier,
            is_export_specifier, is_expression_statement, is_expression_with_type_arguments,
            is_external_module_reference, is_for_in_statement, is_for_of_statement,
            is_for_statement, is_function_declaration, is_function_expression,
            ...
            is_import_keyword, is_import_specifier, is_import_type_node,
            is_index_signature_declaration, is_indexed_access_type_node, is_infer_type_node,
            is_interface_declaration, is_intersection_type_node, is_jsdoc, is_jsdoc_all_type,
            is_jsdoc_augments_tag, is_jsdoc_author_tag, is_jsdoc_callback_tag, is_jsdoc_class_tag,
            is_jsdoc_deprecated_tag, is_jsdoc_enum_tag, is_jsdoc_function_type,
            is_jsdoc_implements_tag, is_jsdoc_link, is_jsdoc_link_code, is_jsdoc_link_plain,
            is_jsdoc_member_name, is_jsdoc_name_reference, is_jsdoc_namepath_type,
            is_jsdoc_non_nullable_type, is_jsdoc_nullable_type, is_jsdoc_optional_type,
            is_jsdoc_override_tag, is_jsdoc_parameter_tag, is_jsdoc_private_tag,
            is_jsdoc_property_tag, is_jsdoc_protected_tag, is_jsdoc_public_tag,
            is_jsdoc_readonly_tag, is_jsdoc_return_tag, is_jsdoc_see_tag, is_jsdoc_signature,
            is_jsdoc_template_tag, is_jsdoc_this_tag, is_jsdoc_type_expression,
            is_jsdoc_type_literal, is_jsdoc_type_tag, is_jsdoc_typedef_tag, is_jsdoc_unknown_tag,
            is_jsdoc_unknown_type, is_jsdoc_variadic_type, is_jsx_attribute, is_jsx_attributes,
            is_jsx_closing_element, is_jsx_closing_fragment, is_jsx_element, is_jsx_expression,
            is_jsx_fragment, is_jsx_opening_element, is_jsx_opening_fragment,
            is_jsx_self_closing_element, is_jsx_spread_attribute, is_jsx_text,
            is_labeled_statement, is_literal_type_node, is_mapped_type_node,
            is_merge_declaration_marker, is_meta_property, is_method_declaration,
            is_method_signature, is_minus_token, is_missing_declaration, is_module_block,
            is_module_declaration, is_named_exports, is_named_imports, is_named_tuple_member,
            is_namespace_export, is_namespace_export_declaration, is_namespace_import,
            is_new_expression, is_no_substitution_template_literal, is_non_null_expression,
            is_not_emitted_statement, is_numeric_literal, is_object_binding_pattern,
            is_object_literal_expression, is_omitted_expression, is_optional_type_node,
            is_parameter, is_parenthesized_expression, is_parenthesized_type_node,
            ...
            is_qualified_name, is_question_dot_token, is_question_token, is_readonly_keyword,
            is_regular_expression_literal, is_rest_type_node, is_return_statement,
            is_semicolon_class_element, is_set_accessor_declaration,
            is_shorthand_property_assignment, is_source_file, is_spread_assignment,
            is_spread_element, is_static_modifier, is_string_literal, is_super_keyword,
            is_switch_statement, is_syntax_list, is_synthetic_expression, is_synthetic_reference,
            is_tagged_template_expression, is_template_expression, is_template_head,
            is_template_literal_type_node, is_template_literal_type_span, is_template_middle,
            is_template_span, is_template_tail, is_this_type_node, is_throw_statement,
            is_try_statement, is_tuple_type_node, is_type_alias_declaration,
            is_type_assertion_expression, is_type_literal_node, is_type_of_expression,
            is_type_operator_node, is_type_parameter_declaration, is_type_predicate_node,
            is_type_query_node, is_type_reference_node, is_union_type_node, is_unparsed_prepend,
            is_unparsed_source, is_variable_declaration, is_variable_declaration_list,
            is_variable_statement, is_void_expression, is_while_statement, is_with_statement,
            is_yield_expression,
        },
        parenthesizer_rules::{create_parenthesizer_rules, null_parenthesizer_rules},
        utilities::{
            ...
            create_external_helpers_import_declaration_if_needed, create_for_of_binding_statement,
        ...
        utilities_public::{set_text_range, set_text_range_id_node, set_text_range_node_array},
    },
    module_name_resolver::{
        ...
        resolve_type_reference_directive, CacheWithRedirects, GetCanonicalFileName, ModeAwareCache,
        ModuleResolutionCache, NonRelativeModuleNameResolutionCache, PackageJsonInfo,
        PackageJsonInfoCache, PerModuleNameCache, TypeReferenceDirectiveResolutionCache,
    },
    module_specifiers,
    parser::{
        ...
        is_external_module, parse_isolated_entity_name, parse_jsdoc_type_expression_for_tests,
        parse_json_text, try_for_each_child, try_for_each_child_bool,
        try_for_each_child_recursively_bool, update_source_file,
    ...
    path::{
        ...
        get_directory_path, get_normalized_absolute_path,
        get_normalized_absolute_path_without_root, get_normalized_path_components,
        get_path_components, get_path_components_relative_to, get_path_from_path_components,
        ...
        path_is_relative, reduce_path_components, remove_trailing_directory_separator,
        resolve_path, starts_with_directory, to_path, try_for_each_ancestor_directory,
        PathAndParts, StringOrBool,
    },
    program::{
        create_compiler_host_worker, create_program, find_config_file,
        flatten_diagnostic_message_text, format_diagnostic, format_diagnostics,
        format_diagnostics_with_color_and_context, format_location,
        get_config_file_parsing_diagnostics, get_implied_node_format_for_file,
        get_pre_emit_diagnostics, get_resolution_diagnostic,
        ...
        CompilerHostLike, CompilerHostLikeRcDynCompilerHost, EmitHostWriteFileCallback,
        FilesByNameValue, ForEachResolvedProjectReference, FormatDiagnosticsHost,
        GetResolvedProjectReferences, GetSymlinkCache, LoadWithLocalCacheLoader,
        LoadWithModeAwareCacheLoader, ToPath,
    },
    scanner::{
    ...
    sourcemap::{
        create_source_map_generator, decode_mappings, get_line_info, is_source_mapping,
    ...
    transformers::{
        ...
        utilities::{
            ...
            collect_external_module_info, get_export_needs_import_star_helper,
            ...
            is_initialized_property, is_non_static_method_or_accessor_with_private_name,
        ...
        ClassLexicalEnvironment, CodeBlock, ConvertedLoopState, PendingDeclaration,
        PrivateIdentifierEnvironment, PrivateIdentifierInfo, PrivateIdentifierKind,
    },
    tsbuild::resolve_config_file_project_name,
    tsbuild_public::{
    ...
    types::{
        ...
        ArrayLiteralExpression, ArrayTypeNode, ArrowFunction, AsExpression, AssertClause,
        AssertEntry, AssignmentDeclarationKind, AutomaticTypeDirectiveFile, AwaitExpression,
        ...
        BaseIntrinsicType, BaseJSDocTag, BaseJSDocTypeLikeTag, BaseJSDocUnaryType,
        ...
        CallSignatureDeclaration, CancellationToken, CaseBlock, CaseClause,
        ...
        CommandLineOptionBaseBuilder, CommandLineOptionInterface, CommandLineOptionMapTypeValue,
        ...
        ConditionalExpression, ConditionalRoot, ConditionalType, ConditionalTypeNode,
        ConfigFileSpecs, ConstructSignatureDeclaration, ConstructorDeclaration,
        ConstructorTypeNode, ContextFlags, ContinueStatement, CoreTransformationContext,
        CreateProgramOptions, CreateProgramOptionsBuilder, CurrentParenthesizerRule,
        CustomTransformer, CustomTransformerFactory, CustomTransformerFactoryInterface,
        CustomTransformerInterface, CustomTransformers, DebuggerStatement, Decorator,
        DefaultClause, DeleteExpression, DetachedCommentInfo, Diagnostic, DiagnosticCategory,
        ...
        EmitHelperText, EmitHelperTextCallback, EmitHint, EmitHost, EmitResolver, EmitResult,
        ...
        FreshableIntrinsicType, FunctionDeclaration, FunctionExpression,
        ...
        GenericableTypeInterface, GetAccessorDeclaration, GetProgramBuildInfo,
        HasAntecedentInterface, HasArgumentsInterface, HasAssertClauseInterface,
        HasChildrenInterface, HasConditionInterface, HasDotDotDotTokenInterface,
        HasElementsInterface, HasExpressionInterface, HasFileNameInterface,
        HasInitializerInterface, HasIsTypeOnlyInterface, HasJSDocDotPosInterface,
        HasLabelInterface, HasLeftAndRightInterface, HasMembersInterface,
        HasModuleSpecifierInterface, HasOldFileOfCurrentEmitInterface, HasPropertiesInterface,
        HasPropertyNameInterface, HasQuestionDotTokenInterface, HasQuestionTokenInterface,
        HasStatementInterface, HasStatementsInterface, HasTagNameInterface, HasTextsInterface,
        ...
        ImportSpecifier, ImportTypeNode, ImportsNotUsedAsValues, IncompleteType, IndexInfo,
        IndexKind, IndexSignatureDeclaration, IndexType, IndexedAccessType, IndexedAccessTypeNode,
        InferTypeNode, InferenceContext, InferenceFlags, InferenceInfo, InferencePriority,
        InputFiles, InputFilesInitializedState, InterfaceDeclaration,
        ...
        JSDocTagInterface, JSDocTemplateTag, JSDocText, JSDocTypeExpression,
        JSDocTypeLikeTagInterface, JSDocTypeLiteral, JSDocTypedefOrCallbackTagInterface,
        JSDocTypedefTag, JsxAttribute, JsxAttributes, JsxClosingElement, JsxClosingFragment,
        JsxElement, JsxEmit, JsxExpression, JsxFlags, JsxFragment, JsxOpeningElement,
        JsxOpeningFragment, JsxOpeningLikeElementInterface, JsxSelfClosingElement,
        JsxSpreadAttribute, JsxText, KeywordTypeNode, LabeledStatement, LanguageVariant,
        LexicalEnvironmentFlags, LibFile, LineAndCharacter, ListFormat, LiteralLikeNodeInterface,
        LiteralType, LiteralTypeInterface, LiteralTypeNode, MappedSymbol, MappedType,
        ...
        NodeArrayOrVecRef, NodeBuilderFlags, NodeCheckFlags, NodeConverters, NodeExt, NodeFactory,
        NodeFlags, NodeId, NodeIdOverride, NodeInterface, NodeLinks, NodeLinksSerializedType,
        NodeSymbolOverride, NonNullExpression, NotActuallyInterfaceType, NumberLiteralType,
        NumericLiteral, ObjectBindingPattern, ObjectFlags, ObjectFlagsTypeInterface,
        ObjectLiteralExpression, ObjectType, ObjectTypeInterface, OmittedExpression,
        OptionalTypeNode, OuterExpressionKinds, PackageId, ParameterDeclaration,
        ParenthesizedExpression, ParenthesizedTypeNode, ParenthesizerRules, ParseConfigHost,
        ParsedCommandLine, ParsedCommandLineBuilder, ParsedCommandLineWithBaseOptions,
        ...
        PragmaArguments, PragmaKindFlags, PragmaName, PragmaPseudoMapEntry, PragmaSpec,
        PragmaValue, PrefixUnaryExpression, PrintHandlers, Printer, PrinterOptions,
        PrinterOptionsBuilder, PrivateIdentifier, Program, ProjectReference,
        ProjectReferenceBuilder, ProjectReferenceFile, PropertyAccessExpression,
        PropertyAssignment, PropertyDeclaration, PropertyDescriptorAttributes,
        PropertyDescriptorAttributesBuilder, PropertySignature, PseudoBigInt, QualifiedName,
        RawSourceMap, RcDynDidYouMeanOptionsDiagnosticsOrRcDynParseCommandLineWorkerDiagnostics,
        RcNodeOrNodeArrayOrVec, ReadonlyTextRange, ReadonlyTextRangeConcrete, RedirectInfo,
        RedirectTargetsMap, RegularExpressionLiteral, RelationComparisonResult,
        RelativeToBuildInfo, RequireResult, ResolvableTypeInterface, ResolvedModuleFull,
        ResolvedModuleFullBuilder, ResolvedModuleWithFailedLookupLocations,
        ResolvedProjectReference, ResolvedProjectReferenceBuilder, ResolvedTypeInterface,
        ResolvedTypeReferenceDirective, ResolvedTypeReferenceDirectiveWithFailedLookupLocations,
        RestTypeNode, ReturnStatement, ReverseMappedSymbol, ReverseMappedType, RootFile,
        ScopedEmitHelper, ScopedEmitHelperBuilder, ScriptKind, ScriptReferenceHost, ScriptTarget,
        ...
        SignatureOptionalCallSignatureCache, SingleNodeOrVecNode, SkipTrivia, SnippetElement,
        ...
        SourceMapEmitResult, SourceMapGenerator, SourceMapRange, SourceMapSource,
        SourceMapSourceRef, SourceTextAsChars, SpreadAssignment, SpreadElement, StringLiteral,
        StringLiteralType, StringMappingType, StringOrDiagnosticMessage, StringOrNodeArray,
        StructureIsReused, SubstitutionType, SwitchStatement, Symbol, SymbolAccessibility,
        SymbolAccessibilityResult, SymbolFlags, SymbolFormatFlags, SymbolId, SymbolInterface,
        SymbolLinks, SymbolTable, SymbolTracker, SymbolTrackerTrackSymbol, SymbolVisibilityResult,
        SymbolWalker, SymbolWriter, SyntaxKind, SyntaxList, SynthesizedComment,
        SyntheticExpression, SyntheticReferenceExpression, TaggedTemplateExpression,
        TemplateExpression, TemplateLiteralLikeNode, TemplateLiteralLikeNodeInterface,
        TemplateLiteralType, TemplateLiteralTypeNode, TemplateLiteralTypeSpan, TemplateSpan,
        Ternary, TextChangeRange, TextRange, TextSpan, ThisTypeNode, ThrowStatement,
        ToHashMapOfCompilerOptionsValues, TokenFlags, TransformFlags, TransformationContext,
        ...
        TypeCheckerHostDebuggable, TypeComparer, TypeComparerCall, TypeFlags, TypeFormatFlags,
        TypeId, TypeInterface, TypeLiteralNode, TypeMapper, TypeMapperCallback,
        TypeMapperCallbackCall, TypeOfExpression, TypeOperatorNode, TypeParameter,
        TypeParameterDeclaration, TypePredicate, TypePredicateKind, TypePredicateNode,
        ...
        UnionTypeNode, UniqueESSymbolType, UnparsedPrepend, UnparsedPrologue,
        UnparsedSectionInterface, UnparsedSource, UnparsedSyntheticReference, UnparsedTextLike,
        UnscopedEmitHelper, UnscopedEmitHelperBuilder, UserPreferences, UserPreferencesBuilder,
    ...
    utilities::{
        ...
        base64_encode, chain_diagnostic_messages, chain_diagnostic_messages_multiple,
        change_extension, changes_affect_module_resolution, changes_affecting_program_structure,
        child_is_decorated, class_or_constructor_parameter_is_decorated, compare_diagnostics,
        ...
        create_diagnostic_for_range, create_file_diagnostic,
        create_file_diagnostic_from_message_chain, create_modifiers, create_range,
        create_symbol_table, create_symlink_cache, create_text_writer, create_token_range,
        create_underscore_escaped_map, declaration_name_to_string,
        ...
        external_helpers_module_name_text, for_each_ancestor,
        ...
        for_each_return_statement_bool, for_each_yield_expression, format_message,
        ...
        get_declaration_from_name, get_declaration_modifier_flags_from_symbol,
        ...
        get_external_module_name_from_declaration, get_external_module_name_from_path,
        ...
        get_initialized_variables, get_initializer_of_binary_expression,
        get_interface_base_type_nodes, get_invoked_expression, get_jsdoc_comment_ranges,
        get_jsdoc_comments_and_tags, get_jsdoc_host, get_jsdoc_root,
        get_jsdoc_type_parameter_declarations, get_jsx_implicit_import_base,
        get_jsx_runtime_import, get_jsx_transform_enabled, get_language_variant,
        get_leading_comment_ranges_of_node, get_leftmost_access_expression,
        get_leftmost_expression, get_line_of_local_position,
        ...
        get_local_symbol_for_export_default, get_locale_specific_message,
        get_members_of_declaration, get_name_from_index_info, get_name_of_expando,
        get_name_or_argument, get_namespace_declaration_node, get_new_line_character,
        get_new_target_container, get_non_augmentation_declaration,
        get_non_decorator_token_pos_of_node, get_object_flags, get_operator_associativity,
        get_operator_precedence, get_original_source_file, get_own_emit_output_file_path,
        get_parameter_symbol_from_jsdoc, get_paths_base_path, get_pattern_from_spec,
        get_property_array_element_value, get_property_assignment,
        ...
        is_aliasable_expression, is_ambient_module, is_any_import_or_re_export,
        ...
        is_declaration_name, is_declaration_name_of_enum_or_namespace, is_declaration_readonly,
        is_declaration_with_type_parameter_children, is_declaration_with_type_parameters,
        is_default_import, is_defaulted_expando_initializer, is_delete_target,
        is_destructuring_assignment, is_dotted_name, is_dynamic_name, is_effective_external_module,
        is_effective_module_declaration, is_effective_strict_mode_source_file,
        is_empty_array_literal, is_empty_object_literal, is_entity_name_expression, is_enum_const,
        is_es_symbol_identifier, is_export_namespace_as_default_declaration, is_exports_identifier,
        is_expression_node, is_expression_with_type_arguments_in_class_extends_clause,
        is_external_module_augmentation, is_external_module_import_equals_declaration,
        is_external_or_common_js_module, is_file_level_unique_name, is_function_block,
        is_function_expression_or_arrow_function, is_function_symbol, is_future_reserved_word,
        is_global_scope_augmentation, is_hoisted_function, is_hoisted_variable_statement,
        is_identifier_a_non_contextual_keyword, is_identifier_name, is_identifier_type_predicate,
        is_identifier_type_reference, is_implicit_glob, is_import_call, is_import_meta,
        is_in_expression_context, is_in_js_file, is_in_jsdoc, is_in_json_file,
        ...
        is_module_exports_access_expression, is_module_identifier,
        is_module_with_string_literal_name, is_namespace_reexport_declaration,
        is_node_descendant_of, is_node_with_possible_hoisted_declaration,
        is_non_global_ambient_module, is_object_literal_method,
        is_object_literal_or_class_expression_method_or_accessor, is_packed_array_literal,
        is_parameter_declaration, is_parameter_or_catch_clause_variable, is_part_of_type_node,
        is_part_of_type_query, is_pinned_comment, is_private_identifier_symbol,
        ...
        is_right_side_of_qualified_name_or_property_access_or_jsdoc_member_name,
        is_same_entity_name, is_shorthand_ambient_module_symbol, is_signed_numeric_literal,
        is_single_or_double_quote, is_source_file_js, is_source_file_not_js,
        is_source_file_not_json, is_special_property_declaration, is_statement_with_locals,
        is_static, is_string_a_keyword, is_string_a_non_contextual_keyword,
        is_string_double_quoted, is_string_or_numeric_literal_like, is_super_call,
        is_super_or_super_property, is_super_property, is_this_identifier, is_this_in_type_query,
        is_this_initialized_declaration, is_this_initialized_object_binding_expression,
        is_this_property, is_this_type_predicate, is_transient_symbol, is_trivia, is_type_alias,
        ...
        is_variable_declaration_in_variable_statement, is_variable_like,
        is_variable_like_or_accessor, is_watch_set, is_write_access, is_write_only_access,
        make_identifier_from_module_name, match_files, match_pattern_or_exact,
        maybe_get_source_file_of_node, maybe_is_node_descendant_of, maybe_set_parent, min_and_max,
        modifier_to_flag, modifiers_to_flags, module_resolution_is_equal_to, move_range_end,
        move_range_past_decorators, move_range_past_modifiers, move_range_pos,
        ...
        options_have_changes, options_have_module_resolution_changes, out_file,
        package_id_to_string, parameter_is_this_keyword, parse_pseudo_big_int,
        position_is_synthesized, positions_are_on_same_line, project_reference_is_equal_to,
        pseudo_big_int_to_string, range_end_is_on_same_line_as_range_start,
        range_end_positions_are_on_same_line, range_is_on_single_line, range_of_node,
        range_of_type_parameters, range_start_positions_are_on_same_line, read_json,
        reg_exp_escape, remove_extension, remove_file_extension,
        ...
        slice_after, slice_after_eq, source_file_may_be_emitted, strip_quotes,
        ...
        ClassImplementingOrExtendingExpressionWithTypeArguments, EmitFileNames,
    ...
    utilities_public::{
        ...
        get_jsdoc_private_tag, get_jsdoc_protected_tag, get_jsdoc_public_tag,
        get_jsdoc_readonly_tag, get_jsdoc_return_tag, get_jsdoc_return_type, get_jsdoc_tags,
        get_jsdoc_template_tag, get_jsdoc_this_tag, get_jsdoc_type, get_jsdoc_type_parameter_tags,
        get_jsdoc_type_tag, get_name_of_declaration, get_name_of_jsdoc_typedef, get_original_node,
        get_parse_tree_node, get_text_of_jsdoc_comment, get_type_parameter_owner,
        has_jsdoc_parameter_tags, has_only_expression_initializer, id_text, is_accessor,
        is_assertion_expression, is_assertion_key, is_binding_name, is_binding_pattern,
        is_break_or_continue_statement, is_call_chain, is_call_like_expression,
        is_call_or_new_expression, is_case_or_default_clause, is_class_element, is_class_like,
        is_class_or_type_element, is_const_type_reference, is_element_access_chain,
        is_empty_binding_element, is_empty_binding_pattern, is_entity_name,
        ...
        is_named_export_bindings, is_non_null_chain, is_nullish_coalesce,
        is_object_literal_element, is_object_literal_element_like, is_optional_chain,
        is_parameter_property_declaration, is_parse_tree_node, is_property_access_chain,
        is_property_access_or_qualified_name, is_property_name, is_set_accessor,
        is_string_literal_like, is_string_text_containing_node, is_template_literal,
        is_template_literal_token, is_template_middle_or_template_tail, is_token, is_token_kind,
        is_type_element, is_type_node, is_type_only_import_or_export_declaration, is_unparsed_node,
        is_unparsed_text_like, maybe_get_original_node, maybe_get_original_node_full,
        skip_partially_emitted_expressions, sort_and_deduplicate_diagnostics, symbol_name,
        text_change_range_is_unchanged, text_change_range_new_span, text_span_contains_position,
        text_span_contains_text_span, text_span_end, text_span_intersection,
        text_span_intersects_with, text_span_intersects_with_position,
        text_span_intersects_with_text_span, text_span_is_empty, text_span_overlap,
        text_span_overlaps_with, try_find_ancestor, unchanged_text_change_range,
    ...
    visitor_public::{
        maybe_visit_each_child, maybe_visit_each_child_full, maybe_visit_node, maybe_visit_nodes,
        ...
        visit_function_body_full, visit_iteration_body, visit_lexical_environment, visit_node,
        visit_nodes, visit_parameter_list, visit_parameter_list_full,
    },
    watch::{
        ...
        explain_if_file_is_redirect, file_include_reason_to_diagnostics,
        get_error_count_for_summary, get_error_summary_text, get_matched_file_spec,
    ...
    watch_utilities::DirectoryStructureHost,
};
#[allow(unused_imports)]
use compiler::{
    binder::{BindBinaryExpressionFlow, Binder},
    checker::{
    ...
    emitter::{
        ...
        get_common_source_directory_of_config, get_output_declaration_file_name,
        get_output_paths_for, get_output_paths_for_bundle, is_build_info_file,
        not_implemented_resolver, EmitBinaryExpression,
    },
    factory::{
    ...
    module_name_resolver::{
        ...
        get_package_name_from_types_package_name, get_package_scope_for_path,
        get_types_package_name, is_trace_enabled, mangle_scoped_package_name,
        node_modules_path_part, path_contains_node_modules, trace, zip_to_mode_aware_cache,
    },
    parser::{
    ...
    program::{
        ...
        ForegroundColorEscapeSequences, GetSourceFile, ReferenceFileLocation,
    ...
    types::{
        ...
        ExportedModulesFromDeclarationEmit, ExternalEmitHelpers, FileIncludeKind,
        FileIncludeReason, IterationTypes, IterationTypesKey, JsxReferenceKind,
        MemberOverrideStatus, ModulePath, OutofbandVarianceMarkerHandler, ReadonlyPragmaMap,
        ReferencedFile, SourceOfProjectReferenceRedirect, WideningContext,
    },
    utilities::{
...
pub use rust_helpers::{
    ...
    uri::encode_uri,
    vec::{SliceExtCloneOrd, VecExt, VecExtClone, VecExtOrd},
    weak_self::WeakSelf,
