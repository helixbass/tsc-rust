...
pub use compiler::{
    ...
    core::{
        add_range, append, append_if_unique_eq, append_if_unique_gc, append_if_unique_rc,
        ...
        maybe_add_range, maybe_append_if_unique_eq, maybe_append_if_unique_gc,
...
pub use rust_helpers::{
    ...
    arena::{static_arena, AllArenas, HasArena, InArena, OptionInArena, downcast_transformer_ref},
    capitalize,
