...
pub use compiler::utilities::{
    ...
    get_alias_declaration_from_name, get_all_accessor_declarations, get_all_super_type_nodes,
    get_allow_js_compiler_option, get_allow_synthetic_default_imports, get_ancestor,
    get_are_declaration_maps_enabled, get_assigned_expando_initializer,
    ...
    get_containing_class_static_block, get_containing_function,
    get_containing_function_declaration, get_containing_function_or_class_static_block,
    get_containing_node_array, get_declaration_emit_extension_for_path,
    get_declaration_emit_output_file_path, get_declaration_from_name,
    ...
    is_declaration_readonly, is_declaration_with_type_parameter_children,
    ...
    is_effective_strict_mode_source_file, is_empty_object_literal, is_entity_name_expression,
    is_enum_const, is_es_symbol_identifier, is_export_namespace_as_default_declaration,
    is_exports_identifier, is_expression_node,
    ...
    is_identifier_type_reference, is_implicit_glob, is_import_call, is_in_expression_context,
    is_in_js_file, is_in_jsdoc, is_in_json_file, is_in_top_level_context,
    ...
    try_remove_extension, type_directive_is_equal_to, type_has_call_or_construct_signatures,
    unreachable_code_is_error, unused_label_is_error, unwrap_innermost_statement_of_label,
