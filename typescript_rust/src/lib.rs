...
pub use compiler::{
    ...
    core::{
        ...
        push_if_unique_gc, push_if_unique_rc, range_equals, range_equals_gc, range_equals_rc,
        reduce_left, reduce_left_no_initial_value, reduce_left_no_initial_value_optional,
        relative_complement, remove_prefix, remove_suffix, replace_element, same_flat_map_rc_node,
