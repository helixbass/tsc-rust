...
pub use compiler::{
    ...
    core::{
        ...
        maybe_map, maybe_same_map, not_implemented, ordered_remove_item_at, pad_left, pad_right,
        pattern_text, push_if_unique_gc, push_if_unique_rc, range_equals_gc, range_equals_rc,
    ...
    types::{
        ...
        Block, BreakStatement, BuildInfo, Bundle, BundleFileInfo, BundleFileSection,
    ...
    visitor_public::{
        maybe_visit_each_child, maybe_visit_each_child_full, try_visit_each_child,
