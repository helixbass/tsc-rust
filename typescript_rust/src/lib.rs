...
pub use compiler::types::{
    ...
    SourceMapRange, SourceMapSource, SourceTextAsChars, SourceTextSliceOrStringOrNodeArray,
...
pub use rust_helpers::source_text::{
    join_source_text_slices, reduce_source_text_slice_or_string_refs,
    reduce_source_text_slice_or_strings, SourceText, SourceTextSlice, SourceTextSliceOrString,
    StrOrSourceTextSliceOrString,
};
