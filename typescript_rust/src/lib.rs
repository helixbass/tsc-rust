...
use compiler::command_line_parser::{
    ...
    convert_to_options_with_absolute_paths, convert_to_tsconfig, generate_tsconfig,
    get_diagnostic_text, inverse_jsx_option_map, lib_map, libs,
    ...
    target_option_declaration, update_error_for_no_input_files, JsonConversionNotifier,
...
pub use compiler::command_line_parser::{
    ...
    convert_type_acquisition_from_json, create_option_name_map, get_compiler_options_diff_value,
    get_parsed_command_line_of_config_file, hash_map_to_compiler_options, option_declarations,
    parse_command_line, parse_command_line_worker, parse_config_file_text_to_json,
    parse_custom_type_option, parse_json_config_file_content,
    parse_json_source_file_config_file_content, parse_list_type_option, read_config_file,
...
pub use compiler::core::{
    ...
    equate_strings_case_sensitive, equate_values, every, fill, filter, filter_iter, filter_mutate,
    ...
    get_ranges_where, get_spelling_suggestion, get_string_comparer, get_ui_locale, group, identity,
    identity_str_to_cow, identity_str_to_owned, index_of_any_char_code, indices_of, insert_sorted,
    last, last_or_undefined, length, map, map_defined, matched_text, maybe_add_range,
...
pub use compiler::types::{
    ...
    RestTypeNode, ReturnStatement, ReverseMappedSymbol, ReverseMappedType, RootFile, ScriptKind,
