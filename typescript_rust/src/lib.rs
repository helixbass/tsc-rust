...
pub use compiler::{
    ...
    core::{
        ...
        sort_and_deduplicate, stable_sort, starts_with, string_contains, sum, take_while,
    ...
    factory::{
        ...
        emit_node::{
            ...
            get_synthetic_leading_comments, get_synthetic_trailing_comments, remove_all_comments,
            set_comment_range, set_comment_range_rc, set_constant_value, set_emit_flags,
            set_source_map_range, set_synthetic_leading_comments,
            set_synthetic_leading_comments_rc, set_synthetic_trailing_comments,
        },
        ...
        utilities::{
            ...
            create_member_access_for_property_name, find_use_strict_prologue,
            ...
            is_identifier_or_this_type_node, is_jsdoc_type_assertion, is_local_name,
            is_module_name, is_outer_expression, is_question_or_exclamation_token,
    ...
    types::{
        ...
        BundleFileSectionInterface, BundleFileSectionKind, CallExpression,
    ...
    utilities::{
        ...
        is_pinned_comment, is_private_identifier_symbol, is_prologue_directive,
        ...
        set_text_range_pos_width, set_value_declaration, should_preserve_const_enums,
        skip_parentheses, skip_type_checking, slice_after, source_file_may_be_emitted,
        strip_quotes, supported_js_extensions_flat, supported_ts_extensions,
        supported_ts_extensions_flat, try_extract_ts_extension, try_for_each_entry,
        try_for_each_entry_bool, try_for_each_import_clause_declaration_bool,
    ...
    utilities_public::{
        ...
        is_unparsed_text_like, skip_partially_emitted_expressions,
        ...
        text_span_intersects_with_position, text_span_intersects_with_text_span,
        text_span_is_empty, text_span_overlap, text_span_overlaps_with, try_find_ancestor,
        unchanged_text_change_range, unescape_leading_underscores,
        validate_locale_and_set_language, walk_up_binding_elements_and_patterns,
