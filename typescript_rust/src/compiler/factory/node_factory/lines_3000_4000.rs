...
impl NodeFactory {
    ...
    pub fn update_for_in_statement(
        ...
        if node.ref_(self).as_for_in_statement().initializer != initializer
            || node.ref_(self).as_for_in_statement().expression != expression
            || node.ref_(self).as_for_in_statement().statement != statement
        {
            self.update(
