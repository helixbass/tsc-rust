...
use crate::{
    ...
    HasArena, InArena, JsonConversionNotifier, Matches, ModuleResolutionKind, Node, OptionInArena,
    OptionTry, ParseConfigHost, Path, TypeAcquisition, WatchOptions,
};
...
pub(super) fn get_extends_config_path(
        ...
        || starts_with(&extended_config, "../")
    {
        ...
        return Ok(Some(extended_config_path));
    }
