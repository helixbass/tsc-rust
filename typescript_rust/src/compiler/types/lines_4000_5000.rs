...
pub struct TypeChecker {
    ...
    pub(crate) current_node: Cell<Option<Id<Node>>>,
    ...
    pub(crate) check_binary_expression: Cell<Option<Id<CheckBinaryExpression>>>,
    pub(crate) emit_resolver: Cell<Option<Id<Box<dyn EmitResolver>>>>,
    pub(crate) node_builder: Cell<Option<Id<NodeBuilder>>>,
    ...
    pub(crate) tuple_types: RefCell<HashMap<String, Id</*GenericType*/ Type>>>,
    pub(crate) union_types: RefCell<HashMap<String, Id</*UnionType*/ Type>>>,
    pub(crate) intersection_types: RefCell<HashMap<String, Id<Type>>>,
    pub(crate) string_literal_types: RefCell<HashMap<String, Id</*StringLiteralType*/ Type>>>,
    pub(crate) number_literal_types: RefCell<HashMap<Number, Id</*NumberLiteralType*/ Type>>>,
    pub(crate) big_int_literal_types: RefCell<HashMap<String, Id</*BigIntLiteralType*/ Type>>>,
    pub(crate) enum_literal_types: RefCell<HashMap<String, Id</*LiteralType*/ Type>>>,
    pub(crate) indexed_access_types: RefCell<HashMap<String, Id</*IndexedAccessType*/ Type>>>,
    pub(crate) template_literal_types: RefCell<HashMap<String, Id</*TemplateLiteralType*/ Type>>>,
    pub(crate) string_mapping_types: RefCell<HashMap<String, Id</*StringMappingType*/ Type>>>,
    pub(crate) substitution_types: RefCell<HashMap<String, Id</*SubstitutionType*/ Type>>>,
    pub(crate) subtype_reduction_cache: RefCell<HashMap<String, Vec<Id<Type>>>>,
    pub(crate) evolving_array_types: RefCell<HashMap<TypeId, Id<Type /*EvolvingArrayType*/>>>,
    ...
    pub(crate) unresolved_symbols: RefCell<HashMap<String, Id<Symbol /*TransientSymbol*/>>>,
    pub(crate) error_types: RefCell<HashMap<String, Id<Type>>>,
    ...
    pub(crate) iteration_types_cache: RefCell<HashMap<String, Id<IterationTypes>>>,
    ...
    pub(crate) reverse_mapped_cache: RefCell<HashMap<String, Option<Id<Type>>>>,
    #[unsafe_ignore_trace]
    pub(crate) in_infer_type_for_homomorphic_mapped_type: Cell<bool>,
    pub(crate) ambient_modules_cache: RefCell<Option<Vec<Id<Symbol>>>>,

    pub(crate) pattern_ambient_modules: RefCell<Option<Vec<Id<PatternAmbientModule>>>>,
    pub(crate) pattern_ambient_module_augmentations: RefCell<Option<HashMap<String, Id<Symbol>>>>,

    pub(crate) global_object_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_function_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_callable_function_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_newable_function_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_array_type: Cell<Option<Id<Type /*GenericType*/>>>,
    pub(crate) global_readonly_array_type: Cell<Option<Id<Type /*GenericType*/>>>,
    pub(crate) global_string_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_number_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_boolean_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_reg_exp_type: Cell<Option<Id<Type /*ObjectType*/>>>,
    pub(crate) global_this_type: Cell<Option<Id<Type /*GenericType*/>>>,
    pub(crate) any_array_type: Cell<Option<Id<Type>>>,
    pub(crate) auto_array_type: Cell<Option<Id<Type>>>,
    pub(crate) any_readonly_array_type: Cell<Option<Id<Type>>>,
    pub(crate) deferred_global_non_nullable_type_alias: Cell<Option<Id<Symbol>>>,

    pub(crate) deferred_global_es_symbol_constructor_symbol: Cell<Option<Id<Symbol>>>,
    pub(crate) deferred_global_es_symbol_constructor_type_symbol: Cell<Option<Id<Symbol>>>,
    pub(crate) deferred_global_es_symbol_type: Cell<Option<Id<Type /*ObjectType*/>>>,
...
pub trait TransientSymbolInterface: SymbolInterface {
    fn symbol_links(&self) -> Id<SymbolLinks>;
