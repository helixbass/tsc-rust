...
pub use compiler::core::{
    ...
    range_equals_rc, reduce_left, reduce_left_no_initial_value, remove_prefix, replace_element,
    ...
    trim_string_start, try_cast, try_to_add_to_set, AssertionLevel, GetCanonicalFileName, MultiMap,
    Pattern,
};
