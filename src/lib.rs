...
pub use compiler::utilities::{
    ...
    get_regular_expressions_for_wildcards, get_resolved_module, get_right_most_assigned_expression,
    ...
    remove_file_extension, resolution_extension_is_ts_or_json, set_parent, set_parent_recursive,
