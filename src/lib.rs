...
pub use compiler::types::{
    ...
    GetAccessorDeclaration, HasAntecedentInterface, HasArgumentsInterface, HasChildrenInterface,
    HasConditionInterface, HasElementsInterface, HasExpressionInterface, HasInitializerInterface,
    HasIsTypeOnlyInterface, HasJSDocDotPosInterface, HasLabelInterface, HasPropertiesInterface,
...
pub use compiler::utilities::{
    ...
    get_class_like_declaration_of_symbol, get_compiler_option_value, get_containing_class,
    ...
    get_literal_text, get_local_symbol_for_export_default, get_locale_specific_message,
    get_members_of_declaration, get_name_of_expando, get_name_or_argument,
