...
pub use compiler::core::{
    ...
    create_get_canonical_file_name, create_multi_map, ends_with, equate_strings_case_insensitive,
    equate_strings_case_sensitive, equate_values, every, filter, filter_mutate, filter_owning,
    find, find_index, first_defined, first_or_undefined, flat_map, flat_map_to_mutable, flatten,
    for_each, for_each_bool, get_ranges_where, get_spelling_suggestion, get_string_comparer,
...
pub use compiler::types::{
    ...
    EmitHelperBase, EmitHint, EmitHost, EmitResolver, EmitResolverDebuggable, EmitTextWriter,
    ...
    Extension, ExternalModuleReference, FileExtensionInfo, FileReference, FlowAssignment, FlowCall,
    FlowCondition, FlowFlags, FlowLabel, FlowNode, FlowNodeBase, FlowReduceLabel, FlowStart,
    FlowSwitchClause, ForInStatement, ForOfStatement, ForStatement, FreshableIntrinsicType,
    ...
    GetAccessorDeclaration, HasConditionInterface, HasElementsInterface, HasExpressionInterface,
    ...
    Symbol, SymbolAccessibilityResult, SymbolFlags, SymbolFormatFlags, SymbolId, SymbolInterface,
...
pub use compiler::utilities::{
    ...
    escape_non_ascii_string, escape_string, export_assignment_is_alias, format_message,
    format_string_from_args, full_triple_slash_amd_reference_path_reg_ex,
    full_triple_slash_reference_path_reg_ex, get_allow_synthetic_default_imports,
    ...
    get_literal_text, get_locale_specific_message, get_name_or_argument, get_object_flags,
    get_operator_associativity, get_operator_precedence, get_property_name_for_property_name_node,
