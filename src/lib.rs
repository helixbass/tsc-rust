...
pub use compiler::module_name_resolver::{
    create_module_resolution_cache, node_module_name_resolver, resolve_module_name, ModeAwareCache,
...
pub use compiler::program::{
    ...
    get_resolution_diagnostic, ActualResolveModuleNamesWorker, FormatDiagnosticsHost,
};
...
pub use compiler::utilities::{
    ...
    has_override_modifier, has_question_token, has_rest_parameter, has_static_modifier,
    has_syntactic_modifier, index_of_node, introduces_arguments_exotic_object,
