...
pub use compiler::types::{
    ...
    IndexSignatureDeclaration, InferTypeNode, InterfaceDeclaration,
    ...
    LiteralTypeNode, MethodDeclaration, MethodSignature, ModifierFlags, ModuleDeclaration,
    ModuleKind, ModuleResolutionHost, ModuleResolutionKind, ModuleSpecifierResolutionHost,
    NamedDeclarationInterface, NamedTupleMember, NewExpression, NewLineKind, Node, NodeArray,
    ...
    ObjectType, ObjectTypeInterface, OptionalTypeNode, OuterExpressionKinds, ParameterDeclaration,
    ...
    PropertyDeclaration, PropertySignature, PseudoBigInt, QualifiedName, ReadonlyTextRange,
    RegularExpressionLiteral, RelationComparisonResult, ResolvableTypeInterface,
    ResolvedTypeInterface, RestTypeNode, ReturnStatement, ScriptTarget, SetAccessorDeclaration,
    ...
    TypeLiteralNode, TypeMapper, TypeParameter, TypeParameterDeclaration, TypePredicate,
    TypePredicateNode, TypeQueryNode, TypeReference, TypeReferenceNode, UnderscoreEscapedMap,
