...
pub use compiler::core::{
    ...
    maybe_first_defined, maybe_for_each, maybe_for_each_bool, not_implemented,
    ordered_remove_item_at, pad_left, pad_right, push_if_unique_rc, range_equals_rc, reduce_left,
    reduce_left_no_initial_value, remove_prefix, replace_element, same_map, set_ui_locale,
