...
pub use compiler::types::{
    ...
    SymbolLinks, SymbolTable, SymbolTracker, SymbolWriter, SyntaxKind, Ternary, TextSpan,
    TokenFlags, TransientSymbol, TransientSymbolInterface, Type, TypeChecker, TypeCheckerHost,
