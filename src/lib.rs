...
use compiler::types::{
    ...
    JsxReferenceKind, MemberOverrideStatus, ModulePath, ReadonlyPragmaMap, ReferencedFile,
...
pub use compiler::types::{
    ...
    AlternateModeDiagnostics, ArrayBindingPattern, ArrayLiteralExpression, ArrayTypeNode,
    ArrowFunction, AsExpression, AssertClause, AssertEntry, AssignmentDeclarationKind,
    AutomaticTypeDirectiveFile, AwaitExpression, BaseBindingLikeDeclaration, BaseDiagnostic,
    ...
    PragmaArguments, PragmaKindFlags, PragmaPseudoMapEntry, PragmaValue, PrefixUnaryExpression,
    ...
    RedirectTargetsMap, RegularExpressionLiteral, RelationComparisonResult, RequireResult,
