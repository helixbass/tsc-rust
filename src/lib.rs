...
pub use compiler::types::{
    ...
    JSDocMemberName, JSDocPropertyLikeTag, JSDocReturnTag, JSDocSeeTag, JSDocTag,
    JSDocTagInterface, JSDocTemplateTag, JSDocText, JSDocThisTag, JSDocTypeExpression,
    ...
    SourceMapRange, SourceTextAsChars, SpreadAssignment, SpreadElement, Statement, StringLiteral,
