...
pub use compiler::core::{
    append_if_unique, concatenate, every, first_defined, for_each, insert_sorted, last_or_undefined,
};
...
pub use compiler::types::{
    ...
    Symbol, SymbolFlags, SymbolFormatFlags, SymbolTable, SymbolTracker, SymbolWriter, SyntaxKind,
...
pub use compiler::utilities::{
    ...
    get_escaped_text_of_identifier_or_literal, get_first_identifier, get_source_file_of_node,
