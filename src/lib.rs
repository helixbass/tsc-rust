...
pub use compiler::types::{
    ...
    SourceFileMayBeEmittedHost, SourceFilePrologueDirective, SourceFilePrologueDirectiveExpression,
...
pub use compiler::utilities::{
    ...
    get_leftmost_expression, get_lines_between_position_and_preceding_non_whitespace_character,
