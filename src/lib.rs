...
pub use compiler::core::{
    ...
    deduplicate_rc, ends_with, equate_strings_case_insensitive, equate_strings_case_sensitive,
    equate_values, every, filter, filter_iter, filter_mutate, filter_owning, find,
    find_best_pattern_match, find_index, find_last, find_last_index, first, first_defined,
    ...
    last_or_undefined, length, map, map_defined, maybe_add_range, maybe_append_if_unique_rc,
    maybe_concatenate, maybe_every, maybe_filter, maybe_first_defined, maybe_for_each,
    maybe_for_each_bool, maybe_map, maybe_same_map, not_implemented, ordered_remove_item_at,
...
pub use compiler::utilities::{
    ...
    is_implicit_glob, is_import_call, is_in_expression_context, is_in_js_file, is_in_jsdoc,
    is_in_json_file, is_in_top_level_context, is_incremental_compilation,
    is_infinity_or_nan_string, is_internal_module_import_equals_declaration, is_intrinsic_jsx_name,
