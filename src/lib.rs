...
pub use compiler::types::{
    ...
    CheckFlags, CompilerHost, CreateProgramOptions, Decorator, Diagnostic, DiagnosticCategory,
    ...
    Signature, SignatureDeclarationBase, SignatureDeclarationInterface, SignatureFlags, SourceFile,
...
pub use compiler::utilities::{
    ...
    has_dynamic_name, is_block_or_catch_scoped, is_external_or_common_js_module, is_import_call,
    is_keyword, is_property_name_literal, is_type_alias, is_write_only_access, modifiers_to_flags,
