...
pub use compiler::utilities::{
    ...
    is_assignment_expression, is_assignment_operator, is_bindable_static_element_access_expression,
    ...
    is_property_name_literal, is_string_or_numeric_literal_like, is_super_property,
