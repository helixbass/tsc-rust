...
pub use compiler::utilities::{
    ...
    get_alias_declaration_from_name, get_allow_synthetic_default_imports, get_ancestor,
    ...
    is_bindable_static_name_expression, is_block_or_catch_scoped, is_computed_non_literal_name,
