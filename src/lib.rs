...
pub use compiler::types::{
    ...
    SpreadElement, StringLiteral, StringLiteralType, StringMappingType, StringOrNodeArray,
    ...
    SyntaxKind, SyntaxList, SynthesizedComment, SyntheticExpression, TaggedTemplateExpression,
    TemplateExpression, TemplateLiteralLikeNode, TemplateLiteralLikeNodeInterface,
    TemplateLiteralType, TemplateLiteralTypeNode, TemplateLiteralTypeSpan, TemplateSpan, Ternary,
    TextChangeRange, TextRange, TextSpan, ThisTypeNode, ThrowStatement,
