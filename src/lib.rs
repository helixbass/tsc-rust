...
pub use compiler::utilities::{
    ...
    get_operator_precedence, get_root_declaration, get_source_file_of_node,
    get_strict_option_value, get_syntactic_modifier_flags, get_text_of_identifier_or_literal,
    ...
    is_function_expression_or_arrow_function, is_import_call, is_in_js_file, is_in_jsdoc,
    is_jsdoc_type_alias, is_keyword, is_logical_or_coalescing_assignment_operator,
