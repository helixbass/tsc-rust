...
pub use compiler::core::{
    ...
    equate_strings_case_sensitive, equate_values, every, filter, filter_mutate, find, find_index,
    first_defined, first_or_undefined, flat_map, flat_map_to_mutable, flatten, for_each,
    for_each_bool, get_ranges_where, get_spelling_suggestion, get_string_comparer,
    identity_str_to_cow, insert_sorted, last, last_or_undefined, length, map, map_defined,
    maybe_for_each, not_implemented, pad_left, pad_right, range_equals, same_map, set_ui_locale,
...
pub use compiler::types::{
    extend_compiler_options, extend_watch_options, maybe_text_char_at_index,
    str_to_source_text_as_chars, text_char_at_index, text_len, text_str_num_chars, text_substring,
    AllAccessorDeclarations, AlternateModeDiagnostics, ArrayBindingPattern, ArrayLiteralExpression,
    ...
    ConditionalExpression, ConditionalTypeNode, ConfigFileSpecs, ConstructSignatureDeclaration,
    ...
    CustomTransformers, DebuggerStatement, Decorator, DefaultClause, DeleteExpression, Diagnostic,
    ...
    DoStatement, ElementAccessExpression, EmitFlags, EmitHelper, EmitHelperBase, EmitHint,
    EmitHost, EmitResolver, EmitResolverDebuggable, EmitTextWriter, EmitTransformers,
    EmptyStatement, EnumDeclaration, EnumMember, ExitStatus, ExportAssignment, ExportDeclaration,
    ...
    PatternAmbientModule, PollingWatchKind, PostfixUnaryExpression, PrefixUnaryExpression,
    PrintHandlers, Printer, PrinterOptions, PrivateIdentifier, Program, ProjectReference,
    ...
    ScriptKind, ScriptReferenceHost, ScriptTarget, SemicolonClassElement, SetAccessorDeclaration,
...
pub use compiler::utilities::{
    ...
    get_leftmost_expression, get_literal_text, get_locale_specific_message, get_name_or_argument,
