...
pub use compiler::types::{
    ...
    CreateProgramOptions, DebuggerStatement, Decorator, DeleteExpression, Diagnostic,
    ...
    JsxElement, JsxEmit, JsxFragment, JsxOpeningElement, JsxOpeningFragment, JsxSelfClosingElement,
    JsxText, KeywordTypeNode, LabeledStatement, LanguageVariant, LineAndCharacter, ListFormat,
