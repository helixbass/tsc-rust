...
pub use compiler::types::{
    ...
    SymbolTable, SyntaxKind, Ternary, TextSpan, TokenFlags, Type, TypeChecker, TypeCheckerHost,
    TypeFlags, TypeInterface, TypeNode, UnionOrIntersectionType, UnionOrIntersectionTypeInterface,
...
pub use compiler::utilities::{
    ...
    create_symbol_table, get_binary_operator_precedence, get_effective_initializer,
