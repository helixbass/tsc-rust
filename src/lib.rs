...
pub use compiler::core::{
    ...
    maybe_concatenate, maybe_every, maybe_first_defined, maybe_for_each, maybe_for_each_bool,
    not_implemented, ordered_remove_item_at, pad_left, pad_right, push_if_unique_rc,
    range_equals_rc, reduce_left, remove_prefix, replace_element, same_map, set_ui_locale,
