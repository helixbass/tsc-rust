...
pub use compiler::utilities::{
    ...
    is_object_literal_or_class_expression_method_or_accessor, is_prologue_directive,
    is_property_access_entity_name_expression, is_property_name_literal, is_prototype_access,
    is_push_or_unshift_identifier, is_require_call, is_signed_numeric_literal, is_static,
