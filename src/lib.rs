...
pub use compiler::types::{
    ...
    CheckFlags, CommandLineOption, CommandLineOptionBase, CommandLineOptionInterface,
    ...
    CompilerOptions, CompilerOptionsValue, ConditionalExpression, ContextFlags,
    ...
    ImportSpecifier, ImportsNotUsedAsValues, InterfaceDeclaration, InterfaceType,
