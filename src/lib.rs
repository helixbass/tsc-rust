...
pub use compiler::utilities::{
    ...
    get_source_text_of_node_from_source_file, get_strict_option_value,
    ...
    is_entity_name_expression, is_expression_with_type_arguments_in_class_extends_clause,
    is_external_or_common_js_module, is_function_block, is_function_expression_or_arrow_function,
    is_import_call, is_in_js_file, is_in_jsdoc, is_jsdoc_type_alias, is_json_source_file,
    ...
    is_prototype_access, is_string_or_numeric_literal_like, is_super_property, is_this_identifier,
