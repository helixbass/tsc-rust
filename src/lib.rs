...
pub use compiler::core::{
    ...
    map, map_defined, maybe_for_each, range_equals, same_map, set_ui_locale, single_or_undefined,
    some, sort_and_deduplicate, starts_with, string_contains, trim_string_start, try_cast,
...
pub use compiler::types::{
    ...
    ConstructorTypeNode, ContextFlags, ContinueStatement, CreateProgramOptions, DebuggerStatement,
    Decorator, DefaultClause, DeleteExpression, Diagnostic, DiagnosticCategory,
...
pub use compiler::utilities::{
    ...
    get_leftmost_expression, get_literal_text, get_locale_specific_message, get_object_flags,
    get_operator_associativity, get_operator_precedence, get_root_declaration,
    get_source_file_of_node, get_strict_option_value, get_syntactic_modifier_flags,
    ...
    is_block_or_catch_scoped, is_dynamic_name, is_entity_name_expression,
    ...
    is_in_jsdoc, is_jsdoc_type_alias, is_keyword, is_logical_or_coalescing_assignment_operator,
    is_object_literal_method, is_prologue_directive, is_property_access_entity_name_expression,
    is_property_name_literal, is_prototype_access, is_string_or_numeric_literal_like,
