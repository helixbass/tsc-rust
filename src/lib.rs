...
pub use compiler::factory::emit_node::dispose_emit_nodes;
...
pub use compiler::types::{
    ...
    EmitFlags, EmitHelper, EmitHint, EmitHost, EmitResolver, EmitTextWriter, EmitTransformers,
    ...
    ExternalModuleReference, FileReference, FlowNode, ForInStatement, ForOfStatement, ForStatement,
