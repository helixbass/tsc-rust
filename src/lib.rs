...
use compiler::module_name_resolver::{
    ...
    mangle_scoped_package_name, node_modules_path_part, trace,
};
...
use compiler::types::{
    ...
    JsxReferenceKind, MemberOverrideStatus, ModulePath, PragmaArgumentType, ReadonlyPragmaMap,
    ReferencedFile, SourceOfProjectReferenceRedirect, StringOrDiagnosticMessage, WideningContext,
};
pub use compiler::types::{
    ...
    NodeCheckFlags, NodeConverters, NodeFactory, NodeFlags, NodeId, NodeInterface, NodeLinks,
    NodeLinksSerializedType, NonNullExpression, NumberLiteralType, NumericLiteral,
    ...
    PrinterOptionsBuilder, PrivateIdentifier, Program, ProjectReference, PropertyAccessExpression,
