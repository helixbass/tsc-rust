...
pub use compiler::core::{
    ...
    maybe_first_defined, maybe_for_each, maybe_for_each_bool, not_implemented, pad_left, pad_right,
    push_if_unique_rc, range_equals_rc, remove_prefix, same_map, set_ui_locale,
