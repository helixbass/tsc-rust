...
pub use compiler::types::{
    ...
    BindingElement, BindingLikeDeclarationInterface, Block, CallExpression, CharacterCodes,
    CheckFlags, ClassLikeDeclarationBase, ClassLikeDeclarationInterface, CommandLineOption,
    ...
    CompilerOptionsValue, ConditionalExpression, ContextFlags, CreateProgramOptions, Decorator,
    ...
    ExitStatus, ExportAssignment, ExportDeclaration, ExportSpecifier, Expression,
    ExpressionStatement, FreshableIntrinsicType, FunctionDeclaration, FunctionExpression,
    ...
    ResolvedTypeInterface, ReturnStatement, ScriptTarget, ShorthandPropertyAssignment, Signature,
    ...
    Statement, StringLiteral, StringLiteralType, StringOrNodeArray, StructureIsReused, Symbol,
...
pub use compiler::utilities::{
    ...
    get_text_of_identifier_or_literal, has_dynamic_name, has_syntactic_modifier,
    is_access_expression, is_ambient_module, is_any_import_or_re_export,
