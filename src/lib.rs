...
pub use compiler::core::{
    ...
    last_or_undefined, length, map, map_defined, maybe_append_if_unique_rc, maybe_every,
    maybe_for_each, maybe_for_each_bool, not_implemented, pad_left, pad_right, push_if_unique_rc,
    range_equals_rc, remove_prefix, same_map, set_ui_locale, single_element_array,
    single_or_undefined, some, sort, sort_and_deduplicate, starts_with, string_contains, sum,
    to_file_name_lower_case, trim_string, trim_string_start, try_cast, try_to_add_to_set,
...
pub use compiler::types::{
    ...
    HasStatementInterface, HasStatementsInterface, HasTypeArgumentsInterface, HasTypeInterface,
    ...
    ReverseMappedSymbol, ScriptKind, ScriptReferenceHost, ScriptTarget, SemicolonClassElement,
    ...
    TypePredicateKind, TypePredicateNode, TypeQueryNode, TypeReference, TypeReferenceNode,
...
pub use compiler::utilities::{
    ...
    get_containing_class, get_containing_function_or_class_static_block,
    get_declaration_modifier_flags_from_symbol, get_declaration_of_kind,
    get_declared_expando_initializer, get_effective_container_for_jsdoc_template_tag,
    ...
    get_emit_module_resolution_kind, get_emit_script_target, get_enclosing_block_scope_container,
    get_end_line_position, get_error_span_for_node, get_es_module_interop,
    ...
    get_operator_associativity, get_operator_precedence, get_pattern_from_spec,
    ...
    is_computed_non_literal_name, is_destructuring_assignment, is_dotted_name, is_dynamic_name,
    ...
    is_parameter_declaration, is_part_of_type_query, is_pinned_comment, is_prologue_directive,
    ...
    is_require_variable_declaration, is_right_side_of_qualified_name_or_property_access,
    ...
    is_this_initialized_declaration, is_this_property, is_type_alias, is_type_node_kind,
    is_umd_export_symbol, is_valid_type_only_alias_use_site, is_variable_like, is_watch_set,
    is_write_only_access, maybe_set_parent, modifier_to_flag, modifiers_to_flags,
    ...
    position_is_synthesized, pseudo_big_int_to_string, remove_extension, remove_file_extension,
    resolution_extension_is_ts_or_json, set_parent, set_parent_recursive, set_text_range_pos,
    ...
    walk_up_parenthesized_types, write_file_ensuring_directories, Associativity,
