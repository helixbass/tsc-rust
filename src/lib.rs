...
pub use compiler::utilities::{
    ...
    get_external_module_name, get_first_constructor_with_body, get_first_identifier,
    ...
    get_operator_associativity, get_operator_precedence, get_right_most_assigned_expression,
    ...
    is_part_of_type_query, is_prologue_directive, is_property_access_entity_name_expression,
    is_property_name_literal, is_prototype_access, is_push_or_unshift_identifier, is_require_call,
    is_require_variable_declaration, is_signed_numeric_literal, is_source_file_js,
    is_special_property_declaration, is_static, is_string_double_quoted,
    is_string_or_numeric_literal_like, is_super_property, is_this_identifier,
