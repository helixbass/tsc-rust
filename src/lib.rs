...
pub use compiler::types::{
    ...
    PropertyAssignment, PropertySignature, ReadonlyTextRange, RelationComparisonResult, SourceFile,
    Statement, StructureIsReused, Symbol, SymbolFlags, SymbolTable, SymbolTracker, SymbolWriter,
    SyntaxKind, Ternary, TextSpan, TokenFlags, Type, TypeChecker, TypeCheckerHost, TypeElement,
    TypeFlags, TypeInterface, TypeNode, TypeReferenceNode, UnionOrIntersectionType,
...
pub use compiler::utilities::{
    ...
    get_first_identifier, is_keyword, is_property_name_literal, node_is_missing, object_allocator,
