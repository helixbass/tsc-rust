...
pub use compiler::utilities::{
    ...
    node_is_missing, node_is_present, node_is_synthesized, object_allocator, out_file,
    package_id_to_string, parse_pseudo_big_int, position_is_synthesized, pseudo_big_int_to_string,
    remove_extension, remove_file_extension, resolution_extension_is_ts_or_json, set_parent,
