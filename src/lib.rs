...
pub use compiler::types::{
    ...
    Ternary, TextRange, TextSpan, TokenFlags, TransientSymbol, TransientSymbolInterface,
    TsConfigOnlyOption, Type, TypeAliasDeclaration, TypeAssertion, TypeChecker, TypeCheckerHost,
    TypeElement, TypeFlags, TypeFormatFlags, TypeId, TypeInterface, TypeLiteralNode, TypeMapper,
    TypeNode, TypeParameter, TypeParameterDeclaration, TypePredicateNode, TypeReference,
