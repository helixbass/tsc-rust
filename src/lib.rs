...
pub use compiler::utilities::{
    ...
    is_computed_non_literal_name, is_declaration_name, is_delete_target,
    ...
    is_identifier_type_predicate, is_implicit_glob, is_import_call, is_in_js_file, is_in_jsdoc,
    ...
    is_this_in_type_query, is_this_initialized_declaration, is_this_property, is_type_alias,
    ...
    modifier_to_flag, modifiers_to_flags, no_truncation_maximum_truncation_length, node_is_missing,
    node_is_present, node_is_synthesized, node_starts_new_lexical_environment, object_allocator,
