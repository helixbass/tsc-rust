...
pub use compiler::types::{
    ...
    ParenthesizerRules, ParsedCommandLine, PartiallyEmittedExpression, Path, PatternAmbientModule,
    ...
    ResolvableTypeInterface, ResolvedModuleFull, ResolvedProjectReference, ResolvedTypeInterface,
    ...
    SwitchStatement, Symbol, SymbolFlags, SymbolFormatFlags, SymbolId, SymbolInterface,
    SymbolLinks, SymbolTable, SymbolTracker, SymbolWriter, SyntaxKind, SyntaxList,
...
pub use compiler::utilities::{
    ...
    get_text_of_node_from_source_text, get_text_of_property_name, get_token_pos_of_node,
    ...
    is_assignment_operator, is_assignment_target, is_bindable_static_access_expression,
    ...
    try_parse_pattern, unused_label_is_error, using_single_line_string_writer,
    walk_up_parenthesized_expressions, Associativity, FunctionFlags, GetLiteralTextFlags,
    OperatorPrecedence, StringOrPattern,
};
