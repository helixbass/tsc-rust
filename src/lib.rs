...
pub use compiler::utilities::{
    ...
    get_regex_from_pattern, get_right_most_assigned_expression, get_root_declaration,
    get_source_file_of_node, get_source_text_of_node_from_source_file,
    get_span_of_token_at_position, get_strict_option_value, get_symbol_name_for_private_identifier,
    ...
    get_token_pos_of_node, get_ts_config_prop_array, get_use_define_for_class_fields,
    has_dynamic_name, has_effective_readonly_modifier, has_static_modifier, has_syntactic_modifier,
