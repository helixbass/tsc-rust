...
pub use compiler::utilities::{
    ...
    get_literal_text, get_locale_specific_message, get_name_of_expando, get_name_or_argument,
    get_new_line_character, get_object_flags, get_operator_associativity, get_operator_precedence,
