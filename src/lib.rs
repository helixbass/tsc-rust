...
pub use compiler::types::{
    ...
    CheckFlags, ClassLikeDeclarationBase, ClassLikeDeclarationInterface,
    ...
    CommentRange, CompilerHost, CompilerOptions, CompilerOptionsValue, ComputedPropertyName,
    ConditionalExpression, ConstructorDeclaration, ContextFlags, CreateProgramOptions, Decorator,
