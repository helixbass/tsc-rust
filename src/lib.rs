...
pub use compiler::core::{
    ...
    identity_str_to_owned, insert_sorted, last, last_or_undefined, length, map, map_defined,
    maybe_append_if_unique_rc, maybe_for_each, not_implemented, pad_left, pad_right,
    push_if_unique_rc, range_equals, same_map, set_ui_locale, single_element_array,
    single_or_undefined, some, sort, sort_and_deduplicate, starts_with, string_contains, sum,
    to_file_name_lower_case, trim_string, trim_string_start, try_cast, AssertionLevel,
...
use compiler::program::{
    ...
    get_mode_for_resolution_at_index, get_referenced_file_location, is_reference_file_location,
    is_referenced_file, ForegroundColorEscapeSequences, ReferenceFileLocation,
...
pub use compiler::types::{
    ...
    ComputedPropertyName, ConditionalExpression, ConditionalTypeNode, ConfigFileSpecs,
    ...
    DidYouMeanOptionsDiagnostics, DoStatement, ElementAccessExpression, EmitFlags, EmitHelper,
    EmitHelperBase, EmitHint, EmitHost, EmitResolver, EmitResolverDebuggable, EmitResult,
    EmitTextWriter, EmitTransformers, EmptyStatement, EnumDeclaration, EnumMember, ExitStatus,
    ...
    ImportSpecifier, ImportTypeNode, ImportsNotUsedAsValues, IndexInfo, IndexKind,
    ...
    TryStatement, TsConfigOnlyOption, TupleTypeNode, Type, TypeAcquisition, TypeAliasDeclaration,
    TypeAssertion, TypeChecker, TypeCheckerHost, TypeCheckerHostDebuggable, TypeFlags,
    TypeFormatFlags, TypeId, TypeInterface, TypeLiteralNode, TypeMapper, TypeOfExpression,
    TypeOperatorNode, TypeParameter, TypeParameterDeclaration, TypePredicate, TypePredicateKind,
    TypePredicateNode, TypeQueryNode, TypeReference, TypeReferenceNode,
    TypeReferenceSerializationKind, UnderscoreEscapedMap, UnionOrIntersectionType,
...
pub use compiler::utilities::{
    ...
    get_emit_module_kind, get_emit_script_target, get_enclosing_block_scope_container,
    get_end_line_position, get_error_span_for_node, get_escaped_text_of_identifier_or_literal,
    get_expando_initializer, get_expression_associativity, get_expression_precedence,
    get_external_module_name, get_file_matcher_patterns, get_first_constructor_with_body,
    get_first_identifier, get_full_width, get_function_flags, get_host_signature_from_jsdoc,
    get_immediately_invoked_function_expression, get_jsdoc_comment_ranges,
    get_jsdoc_comments_and_tags, get_jsdoc_host, get_jsdoc_root,
    get_jsdoc_type_parameter_declarations, get_jsx_transform_enabled, get_language_variant,
    get_leftmost_access_expression, get_leftmost_expression, get_literal_text,
    get_local_symbol_for_export_default, get_locale_specific_message, get_name_of_expando,
    get_name_or_argument, get_new_line_character, get_object_flags, get_operator_associativity,
    get_operator_precedence, get_pattern_from_spec, get_property_name_for_property_name_node,
    get_regex_from_pattern, get_regular_expression_for_wildcard,
    get_regular_expressions_for_wildcards, get_right_most_assigned_expression,
    get_root_declaration, get_source_file_of_node, get_source_text_of_node_from_source_file,
    ...
    get_text_of_property_name, get_this_container, get_token_pos_of_node, get_ts_config_prop_array,
    ...
    is_jsdoc_construct_signature, is_jsdoc_type_alias, is_json_source_file, is_keyword,
    is_literal_import_type_node, is_logical_or_coalescing_assignment_operator,
    is_module_augmentation_external, is_module_exports_access_expression, is_object_literal_method,
    ...
    is_type_node_kind, is_valid_type_only_alias_use_site, is_variable_like, is_watch_set,
    is_write_only_access, maybe_set_parent, modifier_to_flag, modifiers_to_flags, node_is_missing,
    node_is_present, node_is_synthesized, object_allocator, out_file, package_id_to_string,
    parse_pseudo_big_int, position_is_synthesized, pseudo_big_int_to_string, remove_file_extension,
    set_parent, set_parent_recursive, set_text_range_pos, set_text_range_pos_end,
