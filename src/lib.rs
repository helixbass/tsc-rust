...
pub use compiler::types::{
    ...
    StructureIsReused, Symbol, SymbolFlags, SymbolFormatFlags, SymbolInterface, SymbolLinks,
    SymbolTable, SymbolTracker, SymbolWriter, SyntaxKind, Ternary, TextSpan, TokenFlags,
    TransientSymbol, TransientSymbolInterface, Type, TypeChecker, TypeCheckerHost, TypeElement,
    TypeFlags, TypeInterface, TypeLiteralNode, TypeMapper, TypeNode, TypeParameter,
