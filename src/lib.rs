...
use compiler::command_line_parser::{
    ...
    convert_to_tsconfig, get_diagnostic_text, lib_map, libs, module_resolution_option_declarations,
...
pub use compiler::core::{
    ...
    index_of_any_char_code, insert_sorted, last, last_or_undefined, length, map, map_defined,
    maybe_add_range, maybe_append_if_unique_rc, maybe_concatenate, maybe_every, maybe_filter,
    maybe_first_defined, maybe_for_each, maybe_for_each_bool, maybe_map, maybe_same_map,
    not_implemented, ordered_remove_item_at, pad_left, pad_right, push_if_unique_rc,
    ...
    AssertionLevel, Cloneable, MultiMap, Pattern, UnderscoreEscapedMultiMap,
};
...
use compiler::module_name_resolver::{
    create_mode_aware_cache, get_package_scope_for_path, get_types_package_name,
    mangle_scoped_package_name, node_modules_path_part,
};
...
pub use compiler::types::{
    ...
    FlowAssignment, FlowCall, FlowCondition, FlowFlags, FlowLabel, FlowNode, FlowNodeBase,
    FlowReduceLabel, FlowStart, FlowSwitchClause, FlowType, ForInStatement, ForOfStatement,
    ForStatement, FreshObjectLiteralTypeInterface, FreshableIntrinsicType, FunctionDeclaration,
    ...
    HasQuestionTokenInterface, HasStatementInterface, HasStatementsInterface, HasTagNameInterface,
    ...
    ImportSpecifier, ImportTypeNode, ImportsNotUsedAsValues, IncompleteType, IndexInfo, IndexKind,
    IndexSignatureDeclaration, IndexType, IndexedAccessType, IndexedAccessTypeNode, InferTypeNode,
    InferenceContext, InferenceFlags, InferenceInfo, InferencePriority, InputFiles,
    ...
    SignatureKind, SignatureOptionalCallSignatureCache, SourceFile, SourceFileLike,
    SourceFileMayBeEmittedHost, SourceMapRange, SourceTextAsChars, SpreadAssignment, SpreadElement,
    StringLiteral, StringLiteralType, StringMappingType, StringOrNodeArray, StructureIsReused,
    SubstitutionType, SwitchStatement, Symbol, SymbolAccessibility, SymbolAccessibilityResult,
    ...
    SynthesizedComment, SyntheticExpression, TaggedTemplateExpression, TemplateExpression,
    ...
    TokenFlags, TransformFlags, TransformationContext, TransformationResult, Transformer,
    TransformerFactory, TransformerFactoryOrCustomTransformerFactory, TransientSymbol,
    ...
    UnparsedSource, UnparsedTextLike, UserPreferences, UserPreferencesBuilder, VariableDeclaration,
    VariableDeclarationList, VariableLikeDeclarationInterface, VariableStatement, VarianceFlags,
    VisitResult, VoidExpression, WatchDirectoryFlags, WatchDirectoryKind, WatchFileKind,
...
pub use compiler::utilities::{
    ...
    contains_ignored_path, contains_parse_error, copy_entries, create_compiler_diagnostic,
    ...
    default_maximum_truncation_length, directory_probably_exists, empty_file_system_entries,
    ...
    get_emit_declarations, get_emit_flags, get_emit_module_kind, get_emit_module_resolution_kind,
    get_emit_script_target, get_enclosing_block_scope_container, get_end_line_position,
    get_entity_name_from_type_node, get_error_span_for_node, get_es_module_interop,
    get_escaped_text_of_identifier_or_literal, get_expando_initializer,
    ...
    get_locale_specific_message, get_members_of_declaration, get_name_from_index_info,
    get_name_of_expando, get_name_or_argument, get_namespace_declaration_node,
    get_new_line_character, get_new_target_container, get_non_augmentation_declaration,
    get_object_flags, get_operator_associativity, get_operator_precedence,
    ...
    get_ts_config_prop_array_element_value, get_type_parameter_from_js_doc,
    get_use_define_for_class_fields, has_abstract_modifier, has_ambient_modifier,
    has_context_sensitive_parameters, has_dynamic_name, has_effective_modifier,
    has_effective_modifiers, has_effective_readonly_modifier, has_js_file_extension,
    has_json_module_emit_enabled, has_override_modifier, has_question_token, has_rest_parameter,
    has_static_modifier, has_syntactic_modifier, index_of_node, introduces_arguments_exotic_object,
    ...
    is_block_scoped_container_top_level, is_catch_clause_variable_declaration_or_binding_element,
    ...
    is_watch_set, is_write_access, is_write_only_access, match_files, maybe_set_parent,
    ...
    set_node_flags, set_parent, set_parent_recursive, set_resolved_type_reference_directive,
