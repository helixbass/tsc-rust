...
pub use compiler::types::{
    ...
    TypeParameter, TypeParameterDeclaration, TypePredicateNode, TypeReference, TypeReferenceNode,
...
pub use compiler::utilities::{
    ...
    get_emit_script_target, get_emit_script_target, get_escaped_text_of_identifier_or_literal,
