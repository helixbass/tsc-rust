...
pub use compiler::utilities::{
    ...
    expression_result_is_unused, extension_from_path, external_helpers_module_name_text,
    ...
    try_parse_pattern, type_has_call_or_construct_signatures, unreachable_code_is_error,
