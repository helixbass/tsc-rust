...
pub use compiler::utilities::{
    ...
    get_jsdoc_comments_and_tags, get_jsdoc_root, get_jsdoc_type_parameter_declarations,
    ...
    get_locale_specific_message, get_name_of_expando, get_name_or_argument, get_new_line_character,
    get_object_flags, get_operator_associativity, get_operator_precedence, get_pattern_from_spec,
