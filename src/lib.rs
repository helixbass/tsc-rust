...
pub use compiler::types::{
    ...
    CharacterCodes, CheckFlags, CommentKind, CommentRange, CompilerHost, CompilerOptions,
    ...
    TextSpan, TokenFlags, TransientSymbol, TransientSymbolInterface, Type, TypeAliasDeclaration,
