...
pub use compiler::utilities::{
    ...
    get_error_span_for_node, get_escaped_text_of_identifier_or_literal, get_expando_initializer,
    ...
    is_assignment_target, is_bindable_object_define_property_call,
    is_bindable_static_access_expression, is_bindable_static_element_access_expression,
    is_bindable_static_name_expression, is_block_or_catch_scoped, is_destructuring_assignment,
