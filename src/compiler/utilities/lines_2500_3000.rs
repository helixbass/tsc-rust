...
use crate::{
    get_assignment_declaration_kind, get_jsdoc_type_tag, get_text_of_identifier_or_literal,
    is_effective_module_declaration, is_external_module_reference, is_function_like,
    is_private_identifier, is_property_assignment, is_property_name_literal, try_cast,
